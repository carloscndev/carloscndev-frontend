...
- **Text Overlay**: Text on photos requires consistent contrast.
  - _Overlay_: Semi-transparent black (for light text).
  - _Lower Contrast_: Reduce the contrast of the background image itself.
  - _Colorize_: Desaturate image + multiply blend mode with a brand color.
- **Scaling**:
